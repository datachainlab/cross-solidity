...
interface ICrossError {
    ...
    error TPCNotImplemented();
    error UnknownCommitProtocol();
    error LinksNotSupported();
    error Tx0MustBeForSelfChain();
    error UnexpectedReturnValue();
    error ChannelNotFound();
    error AckIsNotSuccess();
    error CoordinatorPhaseNotPrepare();
    error AllTransactionsConfirmed();
    error UnexpectedSourceChannel();
    error UnexpectedCommitStatus();
    error CoordinatorStateInconsistent();
    error CoordinatorTxStatusNotPrepare();
